...
const LogoutButton = dynamic(() => import("../logout-button/page"), { ssr: true });

export default function Navbar({ children, ...props }) {
  const { HOME, PROFILE, COMMUNITY, COLLECTIONS, JOBS, TAGS, QUESTIONS } = ROUTES;
